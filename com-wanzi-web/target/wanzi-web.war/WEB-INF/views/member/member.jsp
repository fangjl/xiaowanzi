    ...
    <header>
                    ...
                    <figure class="fg"
                        ...
                        <figcaption class="fc">
                            <span class="cname" style="color: #957426;">小丸子菜单-会员卡</span>
								<span
                                        class="n"
                                        style="color: rgb(170, 170, 170); text-shadow: rgb(0, 0, 0) 0px -1px;">${member.id}</span>
                        </figcaption>
                    </figure>
                </div>
                <div class="back">
        ...
        <div>
            <ul class="box group_btn">
                <li><a id="myPoint" href="#"><span>我的积分</span><span>${member.score}</span></a></li>
                <li id="signButton" style=""><a href="javascript:charge();"><span>签到即送</span><span>10</span></a></li>
                <li id="signResult" style="padding-top: 12px;display:none;"><a><img src="<%=request.getContextPath()%>/assets/member/img/signed.png" width="20px" height="20px" style="vertical-align: -4px;margin-right:2px;">已签到</a></li>
            </ul>
        </div>
