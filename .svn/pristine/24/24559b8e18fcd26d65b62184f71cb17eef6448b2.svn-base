                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <p>
                                    <button id="bootbox-options" class="btn btn-success" onclick="window.location.href = '<%=request.getContextPath()%>/admin/addArticleReply'">添加</button>
                                </p>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample-table-1">
                                        ...
                                        <c:forEach items="${adminReplies}"  var="ac"   varStatus="st" >
                                            <tr>
                                                ...
                                                <td class="hidden-480">${ac.title}</td>
                                                <td class="hidden-480">
